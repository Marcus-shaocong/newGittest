...
Redirection is allowed immediately after funciton definition
...
#This script prints a littel histogram of how much space
...
(( BASH_VERSINFO[0] < 4 )) && error "This script can be only be run by bash 4 or higher" 1
